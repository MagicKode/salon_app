...
import 'package:salon_flutter/feature/others/servicemenuscreen/sections/service_menu_card.dart';
      ...
      children: [
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemBuilder:
                (context, index) => const ServiceMenuCard(
                  service: MenuService(
                    id: '1',
                    ...
                    duration: "2 hour",
                    description:
                        "A blunt cut bob is a shorter hairstyle that's cut into a straight line.",
                    imageUrl:
