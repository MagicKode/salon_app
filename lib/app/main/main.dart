  ...
  runApp(
    MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider<MasterScheduleRepository>.value(
          value: masterScheduleRepo,
        ),
        RepositoryProvider<MasterCalendarRepository>.value(
          value: masterCalendarRepo,
        ),
      ...
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider<CatalogBloc>(
            create: (_) => CatalogBloc(catalogRepository: catalogRepository),
          ),
          BlocProvider<BookingSlotsBloc>(
            create:
                (_) => BookingSlotsBloc(bookingRepository: bookingRepository),
          ),
          BlocProvider<ReviewBloc>(create: (_) => ReviewBloc(reviewApiService)),
          BlocProvider<MasterCalendarBloc>(
            create:
                (context) => MasterCalendarBloc(
          ...
          BlocProvider(
            create:
                (_) => ThemeCubit(repository: ThemeRepository())..loadTheme(),
          ),
        ],
